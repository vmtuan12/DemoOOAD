...
const role_admin = ref(localStorage.getItem('role') == 'ADMIN')
</script>
...
<template>
    ...
    >
        ...
        >
            ...
            <NavbarButton v-if="role_admin" to="/account" content="Tài khoản">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7">
